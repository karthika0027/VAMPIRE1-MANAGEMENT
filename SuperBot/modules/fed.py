...
import SuperBot.modules.sql.feds_sql as sql
...
from SuperBot.modules.helper_funcs.string_handling import markdown_parser
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "SuperBot_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="SuperBot_fbanned_users.json",
        ...
        if args[0] == "csv":
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "SuperBot_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="SuperBot_fbanned_users.csv",

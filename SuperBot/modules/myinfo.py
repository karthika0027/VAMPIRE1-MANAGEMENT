...
from SuperBot import telethn as bot
from SuperBot import telethn as tgbot
...
async def callback_query_handler(event):
    try:
        ...
        LILIE = "POWERED BY [MR. ᭄ 𝕋𝕀𝕄𝔼 𝕋ℝ𝔸𝕍𝔼𝕃𝕃𝔼ℝ😡⃝⃟➛⃟⃟⃝⃝❼½சனி𝕾𝖖𝖚𝖆𝖉࿐⁰⁰⁷](https://t.me/ROWDY_OF_PLUS) \n\n"

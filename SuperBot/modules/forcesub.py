...
from SuperBot import DRAGONS as SUDO_USERS
from SuperBot import pbot
from SuperBot.modules.sql import forceSubscribe_sql as sql
            ...
            if chat_member.restricted_by.id == (client.get_me()).id:
                try:
                    ...
                    client.answer_callback_query(
                        cb.id,
                        text=f"» ɴᴇᴛᴡᴏʀᴋ @{channel} ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴛʜᴇɴ ᴩʀᴇss 'ᴜɴᴍᴜᴛᴇ ᴍᴇ' ʙᴜᴛᴛᴏɴ.",
                        show_alert=True,
                    )
            else:
                client.answer_callback_query(
            ...
            try:
                ...
                try:
                    sent_message = message.reply_text(
                        "ʜᴇʏ {} 💔 \n **ʏᴏᴜ ʜᴀᴠᴇɴ'ᴛ ɴᴇᴛᴡᴏʀᴋᴇᴅ @{} ᴄʜᴀɴɴᴇʟ ʏᴇᴛ**🧐 \n \nᴩʟᴇᴀsᴇ ɴᴇᴛᴡᴏʀᴋ [ᴛʜɪs ᴄʜᴀɴɴᴇʟ](https://t.me/{}) ᴀɴᴅ ᴛʜᴇɴ ᴩʀᴇss ᴛʜᴇ **ᴜɴᴍᴜᴛᴇ ᴍᴇ** ʙᴜᴛᴛᴏɴ. \n \n ".format(
    ...
    if user.status == "creator" or user.user.id in SUDO_USERS:
        ...
        if len(message.command) > 1:
            ...
            if input_str.lower() in ("off", "no", "disable"):
                ...
                sent_message = message.reply_text(
                    "**» ᴜɴᴍᴜᴛɪɴɢ ᴀʟʟ ᴍᴇᴍʙᴇʀs ᴍᴜᴛᴇᴅ ʙʏ ɴᴏᴛ ɴᴇᴛᴡᴏʀᴋɪɴɢ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ...**"
                )
                try:
                    for chat_member in client.get_chat_members(
                        ...
                        if chat_member.restricted_by.id == (client.get_me()).id:
                            ...
                            time.sleep(1)
                    sent_message.edit(
                        "**» ᴜɴᴍᴜᴛᴇᴅ ᴀʟʟ ᴍᴇᴍʙᴇʀs ᴡʜᴏ ᴀʀᴇ ᴍᴜᴛᴇᴅ ʙʏ ᴍᴇ ғᴏʀ ɴᴏᴛ ɴᴇᴛᴡᴏʀᴋɪɴɢ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ.**"
                    )
                except ChatAdminRequired:
                    sent_message.edit(
...
__help__ = """
  *Force Subscribe:*
  ...
  Super Bot can mute members who are not subscribed your channel until they subscribe When enabled I will mute unsubscribed members and show them a unmute button. When they pressed the button I will unmute them

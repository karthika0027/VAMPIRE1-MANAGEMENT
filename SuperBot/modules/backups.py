...
# from SuperBot.modules.sql import warns_sql as warnssql
import SuperBot.modules.sql.blacklist_sql as blacklistsql

# from SuperBot.modules.sql import cust_filters_sql as filtersql
# import SuperBot.modules.sql.welcome_sql as welcsql
import SuperBot.modules.sql.locks_sql as locksql
import SuperBot.modules.sql.notes_sql as sql

# from SuperBot.modules.rules import get_rules
import SuperBot.modules.sql.rules_sql as rulessql
from SuperBot import JOIN_LOGGER, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from SuperBot.__main__ import DATA_IMPORT
from SuperBot.modules.connection import connected
from SuperBot.modules.helper_funcs.alternate import typing_action
from SuperBot.modules.helper_funcs.chat_status import user_admin
from SuperBot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("SuperBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SuperBot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SuperBot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SuperBot{}.backup".format(chat_id))  # Cleaning file

...
import SuperBot.modules.sql.global_bans_sql as gban_sql
import SuperBot.modules.sql.users_sql as user_sql
from SuperBot import DEV_USERS, OWNER_ID, dispatcher
